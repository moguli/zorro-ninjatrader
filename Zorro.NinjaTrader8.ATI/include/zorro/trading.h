...
#define MAX_QUOTES	2000	// size of T2 orderbook list
...
typedef struct ASSET
{
	...
	int	nNetSum,nVirtualSum; // number of lots of all open trades
...
typedef struct TRADE
{
	...
	float	fMarginCost;	// initial margin cost by the trade
...
#define TR_MISSEDENTRY	(1<<10)	// missed the entry limit or sell price in the last bar
#define TR_MISSEDEXIT	(1<<11)	// missed the exit for some reason
#define TR_NOTFILLED	(1<<12)	// Trade pending in the broker platform
...
//////////////////////////////////////////////////////////////////////
#define SCRIPT_VERSION	256	// some flags changed
#ifndef NO_DEFINES
...
#define CST		-5	// Central Time (Chicago)
